...
- [x] 1.4 Test transition animation matches vuejs.org flowing feel
...
- [x] 2.3 Test default theme is 'light' on fresh load
...
- [x] 4.7 Test dropdown opens/closes on click
...
- [x] 5.5 Test layout on desktop and mobile
...
- [x] 6.3 Verify no flash of incorrect theme on page load
