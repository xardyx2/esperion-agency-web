...
- [ ] Apply currency formatting di list view

**Testing**:
- [ ] Test dari Indonesia (harus tampil IDR)
- [ ] Test dari luar Indonesia (harus tampil USD)
- [ ] Test fallback jika API error (harus tampil USD)
...
**Acceptance Criteria**:
- [ ] Semua 12 artikel punya field `body_id` dengan konten lengkap
- [ ] Min 800 kata per artikel
- [ ] Semua punya array `tags` (3-6 tags)
- [ ] Semua punya `entities` array dengan Wikidata links
- [ ] Semua punya `wordCount` yang akurat
...
**Manual Testing**:
- [ ] Test setiap article detail page renders correctly
- [ ] Test schema dengan [Google Rich Results Test](https://search.google.com/test/rich-results)
- [ ] Verify SpeakableSpecification muncul di schema
- [ ] Verify entity mentions dengan sameAs URLs
- [ ] Verify tags ada di keywords array
...
**Verify**:
- [ ] Semua 12 artikel punya konten lengkap (min 800 kata)
- [ ] Semua punya tags (3-6 tags per artikel)
- [ ] Semua punya entities dengan valid Wikidata URLs
- [ ] Semua images exist di `/articles/` folder
- [ ] Word count akurat
