...
This specification defines the service catalog capabilities for the Esperion agency web platform, including services display, management, and API endpoints.
...
- **THEN** the visitor SHALL be navigated to the service detail page
