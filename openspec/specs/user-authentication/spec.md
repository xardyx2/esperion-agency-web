...
This specification defines the user authentication capabilities for the Esperion agency web platform, including registration, login, JWT token management, and role-based access control.
