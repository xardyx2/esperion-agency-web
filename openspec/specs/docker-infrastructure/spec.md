...
This specification defines the Docker infrastructure capabilities for the Esperion agency web platform, including Docker Compose configuration, hot reload support, and deployment strategies.
