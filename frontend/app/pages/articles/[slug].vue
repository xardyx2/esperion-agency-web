        ...
        <div class="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div class="p-6">
              ...
              <h3 class="text-lg font-semibold text-es-text-primary dark:text-es-text-primary-dark mt-3 mb-2 line-clamp-2 group-hover:text-es-accent-primary dark:group-hover:text-es-accent-primary-dark transition-colors">
                {{ related.title }}
              </h3>
...
// SEO Meta
useSeoMeta({
  title: 'Article - Esperion Digital Agency',
  description: 'Read our latest insights and updates.',
});

// Article data (in production, fetch from API based on slug)
const article = ref({
...
const relatedArticles = [
  { 
    ...
    excerpt_id: 'Learn the essential principles of user interface design.',
    category: 'Design', 
  ...
  { 
    ...
    excerpt_id: 'Essential SEO strategies to improve your online visibility.',
    category: 'Marketing', 
  ...
  { 
    ...
    excerpt_id: 'Maximize your social media presence with these strategies.',
    category: 'Marketing', 
