  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between mb-8">
      ...
      <div class="flex gap-4">
        ...
        >{{ t('dashboard.works_new.cancel') }}</NuxtLink>
        <button
          type="button"
          :disabled="submitting"
          class="px-6 py-3 bg-es-accent-primary dark:bg-es-accent-primary-dark text-es-text-inverse dark:text-es-text-inverse-dark rounded-lg font-semibold hover:bg-es-accent-primary-hover dark:hover:bg-es-accent-primary-hover-dark transition-colors disabled:opacity-60"
          @click="saveWork"
        >
          {{ submitting ? t('dashboard.works_new.saveInProgress') : t('dashboard.works_new.publishButton') }}
        </button>
      </div>
    </div>
      ...
      <div class="lg:col-span-2 space-y-6">
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          ...
          >
            <input
              ...
              type="text"
              :placeholder="t('dashboard.works_new.metrics.labelPlaceholder')"
              class="px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-sm"
            >
            <input
              v-model="metric.value"
              type="text"
              :placeholder="t('dashboard.works_new.metrics.valuePlaceholder')"
              class="px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-sm"
            >
            <input
              v-model="metric.suffix"
              type="text"
              :placeholder="t('dashboard.works_new.metrics.suffixPlaceholder')"
              class="px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-sm"
            >
          </div>
          <button
            class="text-es-accent-primary dark:text-es-accent-primary-dark text-sm font-medium hover:underline"
            @click="addMetric"
          >
            {{ t('dashboard.works_new.metrics.add') }}
          </button>
        </div>
        ...
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          ...
          <input
            ...
            type="text"
            :placeholder="t('dashboard.works_new.details.client.placeholder')"
        ...
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          ...
          >
            <option value="Web Development">
              {{ t('dashboard.works_new.details.service.options.webDevelopment') }}
            </option>
            <option value="Mobile App Development">
              {{ t('dashboard.works_new.details.service.options.mobileAppDevelopment') }}
            </option>
            <option value="UI/UX Design">
              {{ t('dashboard.works_new.details.service.options.uiUxDesign') }}
            </option>
            <option value="Digital Marketing">
              {{ t('dashboard.works_new.details.service.options.digitalMarketing') }}
            </option>
            <option value="E-Commerce Solutions">
              {{ t('dashboard.works_new.details.service.options.ecommerceSolutions') }}
            </option>
            <option value="Consulting">
              {{ t('dashboard.works_new.details.service.options.consulting') }}
            </option>
          </select>
        </div>
        ...
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          ...
          <input
            ...
            type="text"
            :placeholder="t('dashboard.works_new.details.platform.placeholder')"
            class="w-full px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-es-text-primary dark:text-es-text-primary-dark focus:outline-none focus:ring-2 focus:ring-es-accent-primary"
          >
        </div>
      </div>
      ...
      <div class="space-y-6">
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          ...
          <input
            v-model="form.slug"
            type="text"
            :placeholder="t('dashboard.works_new.details.slug.placeholder')"
            class="w-full px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-es-text-primary dark:text-es-text-primary-dark focus:outline-none focus:ring-2 focus:ring-es-accent-primary"
          >
        </div>
        ...
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          <h3 class="text-lg font-semibold text-es-text-primary dark:text-es-text-primary-dark mb-4">
            {{ t('dashboard.works_new.details.featured') }}
          </h3>
        ...
        <div class="bg-es-bg-secondary dark:bg-es-bg-secondary-dark rounded-xl p-6">
          <h3 class="text-lg font-semibold text-es-text-primary dark:text-es-text-primary-dark mb-4">
            {{ t('dashboard.works_new.image.title') }}
          </h3>
          ...
          <input
            v-model="form.image"
            type="text"
            :placeholder="t('dashboard.works_new.image.placeholder')"
            class="w-full px-4 py-2 bg-es-bg-primary dark:bg-es-bg-primary-dark border border-es-border dark:border-es-border-dark rounded-lg text-es-text-primary dark:text-es-text-primary-dark focus:outline-none focus:ring-2 focus:ring-es-accent-primary"
          >
        </div>
      </div>
