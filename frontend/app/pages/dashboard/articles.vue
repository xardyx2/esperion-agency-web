      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead class="bg-es-bg-tertiary dark:bg-es-bg-tertiary-dark">
            <tr>
              <th class="px-6 py-3 text-left text-xs font-medium text-es-text-secondary dark:text-es-text-secondary-dark uppercase tracking-wider">Title</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-es-text-secondary dark:text-es-text-secondary-dark uppercase tracking-wider">Category</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-es-text-secondary dark:text-es-text-secondary-dark uppercase tracking-wider">Status</th>
              <th class="px-6 py-3 text-left text-xs font-medium text-es-text-secondary dark:text-es-text-secondary-dark uppercase tracking-wider">Date</th>
              <th class="px-6 py-3 text-right text-xs font-medium text-es-text-secondary dark:text-es-text-secondary-dark uppercase tracking-wider">Actions</th>
            </tr>
          </thead>
            ...
            <tr v-for="article in filteredArticles" :key="article.id" class="hover:bg-es-bg-tertiary dark:hover:bg-es-bg-tertiary-dark">
              <td class="px-6 py-4">
                <div>
                  ...
                  <div class="text-sm text-es-text-secondary dark:text-es-text-secondary-dark">by {{ article.author }}</div>
                </div>
              </td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <span :class="article.published ? 'bg-green-500/10 text-green-500' : 'bg-yellow-500/10 text-yellow-500'" class="px-3 py-1 text-xs rounded-full font-medium">
              ...
              <td class="px-6 py-4 text-right">
                <div class="flex items-center justify-end gap-2">
                  <button class="p-2 hover:bg-es-bg-primary dark:hover:bg-es-bg-primary-dark rounded-lg transition-colors" title="Edit">
                    ✏️
                  </button>
                  <button class="p-2 hover:bg-es-bg-primary dark:hover:bg-es-bg-primary-dark rounded-lg transition-colors" title="Delete">
                    🗑️
                  </button>
                </div>
              </td>
