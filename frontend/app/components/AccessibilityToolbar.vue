  ...
  <div class="fixed bottom-4 right-4 z-50">
    ...
    >
      ...
      >
        ...
        <span
          :class="isHighContrast ? 'bg-es-accent-primary' : 'bg-es-bg-tertiary'"
          class="w-10 h-5 rounded-full relative transition-colors"
        >
          <span
            :class="isHighContrast ? 'translate-x-5' : 'translate-x-0'"
      ...
      <div class="mt-3 pt-3 border-t border-es-border dark:border-es-border-dark">
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex-1 h-2 bg-es-bg-tertiary dark:bg-es-bg-tertiary-dark rounded-full">
            <div
              class="h-2 bg-es-accent-primary rounded-full transition-all"
