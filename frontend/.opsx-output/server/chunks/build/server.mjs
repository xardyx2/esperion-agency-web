...
import { hasInjectionContext, inject, toRef, isRef, defineComponent, shallowRef, getCurrentInstance as getCurrentInstance$1, provide, cloneVNode, h, createElementBlock, computed, ref, customRef, toValue, onServerPrefetch, reactive, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, mergeProps, getCurrentScope, withCtx, isReadonly, toRaw, useSSRContext, isShallow, isReactive, watch } from 'vue'
import { r as createError$1, B as parseURL, C as encodePath, D as decodePath, E as klona, F as hasProtocol, G as isScriptProtocol, x as joinURL, H as getRequestURL, I as withQuery, J as defu, K as getRequestHeader, L as isEqual, M as sanitizeStatusCode, N as defuFn, O as getContext, P as setCookie, Q as getCookie, R as deleteCookie, S as parsePath, T as parseQuery, $ as $fetch$1, U as baseURL, V as hash, W as executeAsync, X as withHttps, Y as camelCase, Z as withLeadingSlash, _ as withoutTrailingSlash, a0 as withBase, a1 as withTrailingSlash, a2 as createDefu, a3 as isEqual$1 } from '../_/nitro.mjs'
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { payload: true, payload: true }, $1 = {}, $2 = { redirect: '/sitemap_index.xml' }, $3 = { ssr: false }
  return (m, p) => {
    let r = []
    ...
    if (p === '/') {
      ...
      r.unshift({ data: $0 })
    } else if (p === '/id/contact-us') {
      r.unshift({ data: $0 })
    } else if (p === '/en/contact-us') {
      r.unshift({ data: $0 })
    } else if (p === '/id/privacy-policy') {
      r.unshift({ data: $0 })
    } else if (p === '/en/privacy-policy') {
      r.unshift({ data: $0 })
    } else if (p === '/id/terms-of-service') {
      r.unshift({ data: $0 })
    } else if (p === '/en/terms-of-service') {
      r.unshift({ data: $0 })
      ...
      r.unshift({ data: $1 })
    } else if (p === '/__sitemap__/id-ID.xml') {
      r.unshift({ data: $1 })
    ...
    if (l > 1) {
      if (s[1] === 'dashboard') {
        ...
        if (l > 2) {
          if (s[2] === 'dashboard') {
            r.unshift({ data: $3, params: { _: s.slice(3).join('/') } })
          } else if (s[2] === 'capital') {
            r.unshift({ data: $3, params: { _: s.slice(3).join('/') } })
          } else if (s[2] === 'our-works') {
            r.unshift({ data: $0, params: { _: s.slice(3).join('/') } })
          } else if (s[2] === 'our-services') {
            r.unshift({ data: $0, params: { _: s.slice(3).join('/') } })
          } else if (s[2] === 'articles') {
            r.unshift({ data: $0, params: { _: s.slice(3).join('/') } })
          }
        }
...
const component_45stubvKPawHkiJmF8XyC4cCvl02h52Acq4Sj1YtOApTgWR8k = {}
const _routes = [
  {
    name: 'index',
    path: '/',
    component: () => import('./index-C4fH5q_M.mjs')
  },
  {
    name: 'dashboard-analytics___id',
    path: '/id/dashboard/analytics',
    component: () => import('./analytics-C6TGmR26.mjs')
  },
  {
  ...
  {
    name: 'dashboard-api-docs___id',
    path: '/id/dashboard/api-docs',
    component: () => import('./api-docs-BQ5abBFG.mjs')
  },
  {
    name: 'dashboard-api-docs___en',
    path: '/en/dashboard/api-docs',
    component: () => import('./api-docs-BQ5abBFG.mjs')
  },
  {
    name: 'dashboard-articles___id',
    path: '/id/dashboard/articles',
    component: () => import('./articles-2XAA8N2w.mjs'),
    children: [
      {
        name: 'dashboard-articles-new___id',
        path: 'new',
        component: () => import('./new-B67GrL-2.mjs')
      },
      {
        name: 'dashboard-articles-id___id',
        path: ':id()',
        component: () => import('./_id_-CucULdDv.mjs')
      }
    ]
  },
  {
    ...
    children: [
      {
        name: 'dashboard-articles-new___en',
        path: 'new',
        component: () => import('./new-B67GrL-2.mjs')
      },
      {
        name: 'dashboard-articles-id___en',
        path: ':id()',
        component: () => import('./_id_-CucULdDv.mjs')
      }
    ]
  ...
  {
    name: 'dashboard-clients___id',
    path: '/id/dashboard/clients',
    component: () => import('./clients-BKXAhsgI.mjs')
  },
  {
    name: 'dashboard-clients___en',
    path: '/en/dashboard/clients',
    component: () => import('./clients-BKXAhsgI.mjs')
  },
  {
    name: 'dashboard-contact___id',
    path: '/id/dashboard/contact',
    component: () => import('./contact-BkQ9_DG2.mjs')
  },
  {
    name: 'dashboard-contact___en',
    path: '/en/dashboard/contact',
    component: () => import('./contact-BkQ9_DG2.mjs')
  },
  {
    name: 'dashboard-media___id',
    path: '/id/dashboard/media',
    component: () => import('./media-DbBRmLFA.mjs')
  },
  {
    name: 'dashboard-media___en',
    path: '/en/dashboard/media',
    component: () => import('./media-DbBRmLFA.mjs')
  },
  {
    name: 'dashboard-services___id',
    path: '/id/dashboard/services',
    component: () => import('./services-DPZKfaDW.mjs')
  },
  {
    name: 'dashboard-services___en',
  ...
  },
  {
    ...
    component: () => import('./sessions-BbxAgdnG.mjs')
  },
  {
  ...
  {
    name: 'dashboard-settings___id',
    path: '/id/dashboard/settings',
    component: () => import('./settings-C22kKC-h.mjs')
  },
  {
  ...
  {
    name: 'dashboard-users___id',
    path: '/id/dashboard/users',
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./users-DxNzbYGY.mjs')
  },
  {
  ...
  {
    name: 'dashboard-works___id',
    path: '/id/dashboard/works',
    component: () => import('./works-DWx-O5sh.mjs'),
    children: [
      {
        name: 'dashboard-works-new___id',
        path: 'new',
        component: () => import('./new-tPwo7eX2.mjs')
      }
    ]
  },
  {
    name: 'dashboard-works___en',
    path: '/en/dashboard/works',
    component: () => import('./works-DWx-O5sh.mjs'),
    children: [
      {
        name: 'dashboard-works-new___en',
        path: 'new',
        component: () => import('./new-tPwo7eX2.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./_slug_-DRUPvfX3.mjs')
  },
  {
  ...
  {
    name: 'our-services-slug___id',
    path: '/id/our-services/:slug()',
    component: () => import('./_slug_-BWyp3QyG.mjs')
  },
  {
    name: 'our-services-slug___en',
    path: '/en/our-services/:slug()',
    component: () => import('./_slug_-BWyp3QyG.mjs')
  },
  {
    name: 'our-works-slug___id',
    path: '/id/our-works/:slug()',
    component: () => import('./_slug_-CEJADSBs.mjs')
  },
  {
    name: 'our-works-slug___en',
    path: '/en/our-works/:slug()',
    component: () => import('./_slug_-CEJADSBs.mjs')
  },
  {
    name: 'about___id',
    path: '/id/about',
    component: () => import('./about-Ca_uV8__.mjs')
  },
  {
    name: 'about___en',
    path: '/en/about',
  ...
  },
  {
    name: 'articles___id',
    path: '/id/articles',
    component: () => import('./index-C2v_sGdT.mjs')
  },
  {
    name: 'articles___en',
    path: '/en/articles',
  ...
  },
  {
    ...
    path: '/id/contact-us',
    component: () => import('./contact-us-DpIX3_68.mjs')
  },
  {
  ...
  },
  {
    name: 'dashboard___id',
    path: '/id/dashboard',
    component: () => import('./index-Cp31YS9j.mjs')
  },
  {
    name: 'dashboard___en',
    path: '/en/dashboard',
  ...
  },
  {
    name: 'login___id',
    path: '/id/login',
    component: () => import('./login-Cm0YMzoe.mjs')
  },
  {
    name: 'login___en',
    path: '/en/login',
  ...
  },
  {
    name: 'offline___id',
    path: '/id/offline',
    component: () => import('./offline-BhWlAfFa.mjs')
  },
  {
    name: 'offline___en',
    path: '/en/offline',
  ...
  {
    name: 'our-services___id',
    path: '/id/our-services',
    component: () => import('./index-Dd1NLARf.mjs')
  },
  {
  ...
  },
  {
    name: 'our-works___id',
    path: '/id/our-works',
    component: () => import('./index-DsGw9bfH.mjs')
  },
  {
    name: 'our-works___en',
    path: '/en/our-works',
  ...
  },
  {
    ...
    component: () => import('./privacy-policy-CyD_ywAE.mjs')
  },
  {
  ...
  },
  {
    name: 'register___id',
    path: '/id/register',
    component: () => import('./register-GdcC4n0J.mjs')
  },
  {
    name: 'register___en',
    path: '/en/register',
  ...
  },
  {
    ...
    component: () => import('./terms-of-service-B8rnBXVt.mjs')
  },
  {
  ...
  },
  {
    name: 'all___id',
    path: '/id/:all(.*)*',
    component: () => import('./_...all_-CmZA2XPc.mjs')
  },
  {
    name: 'all___en',
    path: '/en/:all(.*)*',
  ...
  {
    name: 'scalar___id',
    path: '/id/dashboard/api-docs:pathMatch(.*)*',
    meta: { layout: false, configuration: { darkMode: true, metaData: { title: 'Esperion API Documentation' }, pathRouting: { basePath: '/dashboard/api-docs' }, showSidebar: true, devtools: true, configurations: [], layout: false, url: 'http://localhost:8081/api/v1/openapi.json', proxyUrl: 'https://proxy.scalar.com' }, isOpenApiEnabled: false },
    component: () => import('./ScalarPage-C8YYesOR.mjs')
  },
  {
    name: 'scalar___en',
    path: '/en/dashboard/api-docs:pathMatch(.*)*',
    meta: { layout: false, configuration: { darkMode: true, metaData: { title: 'Esperion API Documentation' }, pathRouting: { basePath: '/dashboard/api-docs' }, showSidebar: true, devtools: true, configurations: [], layout: false, url: 'http://localhost:8081/api/v1/openapi.json', proxyUrl: 'https://proxy.scalar.com' }, isOpenApiEnabled: false },
    component: () => import('./ScalarPage-C8YYesOR.mjs')
  },
  {
    ...
    path: '/id/sitemap.xml',
    component: component_45stubvKPawHkiJmF8XyC4cCvl02h52Acq4Sj1YtOApTgWR8k
  },
  {
    name: __nuxt_page_meta?.name,
    path: '/en/sitemap.xml',
...
const LazyIcon = defineAsyncComponent(() => import('./index-DJ8UoAu3.mjs').then(r => r['default'] || r.default || r))
...
function useCsrf() {
  const headerName = (/* @__PURE__ */ useRuntimeConfig()).public.csurf.headerName ?? ''
  {
    return { csrf: useNuxtApp().ssrContext?.event?.context?.csrfToken, headerName }
  }
}
const plugin_xdQC2I5FZA9BN_8d8MWCXWAuqLDNRFNSkZczMVXWDIs = /* @__PURE__ */ defineNuxtPlugin(() => {
  const csrfFetch = $fetch$1.create({
    onRequest({ options }) {
  ...
  id: [
    {
      ...
      load: () => import(
        './id-D2tQy-Xe.mjs'
        /* webpackChunkName: "locale_id_46json_38644f3f" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-Bj8AcemI.mjs'
        /* webpackChunkName: "locale_en_46json_a24018ab" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${'/_i18n/4zsTHPbr'}/${locale}/messages.json`, { headers })
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map(locale => `${'/_i18n/4zsTHPbr'}/${locale}/messages.json`))
...
const nuxt_studio_jgCyEIabmIM5T8zZP1ivJ8CE0quUwP1XapcWcQd3DDo = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const isStudioMode = false
  const addEditableMarker = (element, field) => {
    return
  }
...
const plugins = [
  ...
  nuxt_studio_jgCyEIabmIM5T8zZP1ivJ8CE0quUwP1XapcWcQd3DDo,
  ssg_detect_IpHCGcQQ_IR5Rl99qyukWoMA9fJGfuTYyoksTzy81cs,
  init_IycSiUTa0ooOjNElHE0EG94Rz0cZb4_bKuXwa_4z9aY
]
const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-2w0g_TlM.mjs').then(m => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BvLpe85u.mjs').then(m => m.default || m))
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0
    const _Error404 = defineAsyncComponent(() => import('./error-404-DSExEW9Z.mjs'))
    const _Error = defineAsyncComponent(() => import('./error-500-DnoMt2yC.mjs'))
...
export { _export_sfc as _, useLocalePath as a, useI18n as b, useSeoMeta as c, useSchemaOrg as d, entry_default as default, useRuntimeConfig as e, useRouter as f, useRoute as g, useAsyncData as h, createError as i, encodeRoutePath as j, useNuxtApp as k, nuxtLinkDefaults as l, useCookie as m, navigateTo as n, useState as o, useFetch as p, useRequestURL as q, resolveRouteObject as r, useAppConfig as s, __nuxt_component_3 as t, useHead as u }
