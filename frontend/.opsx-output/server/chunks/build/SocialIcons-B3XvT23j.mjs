import { defineComponent, mergeProps, unref, createVNode, resolveDynamicComponent, h, useSSRContext } from 'vue'
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderVNode } from 'vue/server-renderer'
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const socialsWithIcons = publicIdentity.socials.map(social => ({
      ...social,
      icon: iconMap[social.name]
    }))
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: 'social-icons' }, _attrs))} data-v-97cb2fcc><!--[-->`)
      ssrRenderList(unref(socialsWithIcons), (social) => {
        _push(`<a${ssrRenderAttr('href', social.url)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr('aria-label', social.label)} class="social-icon-link" data-v-97cb2fcc>`)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add('app/components/ui/SocialIcons.vue')
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0
}
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [['__scopeId', 'data-v-97cb2fcc']]), { __name: 'SocialIcons' })

export { __nuxt_component_0 as _ }
// # sourceMappingURL=SocialIcons-B3XvT23j.mjs.map
