...
import { c as appRootTag, e as appRootAttrs, f as buildAssetsURL, g as appSpaLoaderTag, h as appSpaLoaderAttrs, u as useRuntimeConfig, i as useStorage, j as getResponseStatusText, k as getResponseStatus, l as appId, m as defineRenderHandler, p as publicAssetsURL, n as appTeleportTag, o as appTeleportAttrs, q as getQuery, r as createError, v as appHead, d as destr, w as getRouteRules, x as joinURL, b as useNitroApp } from '../_/nitro.mjs'
...
const handler = defineRenderHandler(async (event) => {
  ...
  if (!NO_SCRIPTS) {
    ...
    // 5. Payloads
    ssrContext.head.push({ script: _PAYLOAD_INLINE
