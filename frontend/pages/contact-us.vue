                ...
                <div class="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label
                      ...
                      class="block text-sm font-medium text-es-text-primary dark:text-es-text-primary-dark mb-2"
                    >
                      Email <span class="text-es-accent-primary">*</span>
                    </label>
                    <input
                      id="email"
                      v-model="form.email"
...
useSeoMeta({
  ...
  ogUrl: 'https://esperion.one/id/contact-us',
  ogType: 'website',
  ...
  alternates: {
    canonical: 'https://esperion.one/id/contact-us'
  },
  link: [
    { rel: 'alternate', hreflang: 'id', href: 'https://esperion.one/id/contact-us' },
    { rel: 'alternate', hreflang: 'en', href: 'https://esperion.one/en/contact-us' },
    { rel: 'alternate', hreflang: 'x-default', href: 'https://esperion.one/id/contact-us' }
  ]
})
...
useSchemaOrg([
  defineWebPage({
    ...
    'url': 'https://esperion.one/id/contact-us',
  ...
  defineBreadcrumbList({
    itemListElement: [
      ...
      },
      {
        ...
        'position': 2,
        'name': 'Kontak Kami',
        'item': 'https://esperion.one/id/contact-us'
      }
    ]
  })
])
