...
fn build_router(state: AppState) -> axum::Router {
    ...
    let router = axum::Router::new()
        ...
        .route("/api/v1/email/settings", get(handlers::email_management::list_email_settings))
        .route("/api/v1/email/settings", post(handlers::email_management::create_email_settings))
        .route("/api/v1/email/settings/:id", put(handlers::email_management::update_email_settings))
        .route("/api/v1/email/settings/:id", delete(handlers::email_management::delete_email_settings))
        .route("/api/v1/email/templates", get(handlers::email_management::list_email_templates))
        .route("/api/v1/email/templates", post(handlers::email_management::create_email_template))
        .route("/api/v1/email/templates/:slug", get(handlers::email_management::get_email_template))
        .route("/api/v1/email/templates/:id", put(handlers::email_management::update_email_template))
        .route("/api/v1/email/templates/:id", delete(handlers::email_management::delete_email_template))
        .route("/api/v1/email/logs", get(handlers::email_management::list_email_logs))
        .route("/api/v1/email/logs/:id", get(handlers::email_management::get_email_log))
        .route("/api/v1/email/send-with-template", post(handlers::email_management::send_email_with_template))
